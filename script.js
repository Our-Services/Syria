document.addEventListener('DOMContentLoaded', () => {
  ...
  // لا تجهيز مبكر عند preload=none لتجنب طلبات مبكرة
  let prepared = false;
  ...
  const tick = () => {
    ...
    // لا تحضير مسبق؛ سنبدأ فقط عند الموعد لتجنب انقطاعات مبكرة
    ...
    if (y === 2024 && m === 12 && d === 8 && hh === 0 && mm === 0 && ss === 0) {
      ...
      setTimeout(async () => {
        ...
        // التعافي من الانتظار/التعثّر بمحاولة متابعة التشغيل بشكل بسيط ومتوافق
